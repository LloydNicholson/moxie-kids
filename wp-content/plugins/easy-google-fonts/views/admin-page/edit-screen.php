		...
		<div class="control-edit">
			...
			<div id="post-body">
				<div id="post-body-content">
						...
						<p><?php _e( "Please check the box below if you wish to override all of the css for the selectors above that are forced in your theme's stylesheet.", $this->plugin_slug ); ?></p>
