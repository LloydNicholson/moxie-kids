...
/**
 * This class provides functions for converting CSS css into inline style attributes in your HTML code.
 *
...
class Emogrifier
{
    ...
    /**
     * the css to apply to the nodes with the XPath paths as array keys for the outer array
    ...
    /**
     * Determines whether CSS css that have an equivalent HTML attribute
    ...
    protected function process()
    {
        ...
        // (these blocks should be appended so as to have precedence over conflicting css in the existing CSS)
        $allCss = $this->css;
     ...
     * Applies $css to $node.
     *
     * This method maps CSS css to HTML attributes and adds those to the
     * node.
     *
     * @param string[] $styles the new CSS css taken from the global css to be applied to this node
     * @param \DOMElement $node node to apply css to
     *
     * @return void
     */
    ...
    /**
     * Disables the parsing of inline css.
     *
     * @return void
     */
    ...
    /**
     * This removes css from your email that contain display:none.
     ...
     * Also stores a reference of nodes with existing inline css so we don't overwrite them.
     *
     * @param \DOMXPath $xPath
     *
     * @return void
    ...
    private function normalizeStyleAttributes(\DOMElement $node)
    {
        ...
        // have to save the original HTML css
    ...
    /**
     * Merges css from css attributes and style nodes and applies them to the attribute nodes
     *
     * @return void
     */
    ...
    private function generateStyleStringFromDeclarationsArrays(array $oldStyles, array $newStyles)
    {
        ...
        // Unset the overridden css to preserve order, important if shorthand and individual properties are mixed
