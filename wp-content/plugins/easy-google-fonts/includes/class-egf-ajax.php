...
if ( ! class_exists( 'EGF_Ajax' ) ) :
	class EGF_Ajax {
		 ...
		 * be added to the css upon output. Note: the
		...
		public function force_font_control_styles() {
			...
			if ( isset( $_POST['controlId'] ) ) {
				...
				$switch     = ( isset( $_POST['force-css'] ) && 'true' == $_POST['force-css'] ) ? true : false;
		...
		public function update_control_instance() {
			...
			if ( isset( $_POST['force-css'] ) ) {
				$force_styles = ( 'true' == $_POST['force-css'] ) ? true : false;
			}
