...
if ( ! class_exists( 'EGF_Register_Options' ) ) :
	class EGF_Register_Options {
		 ...
		 * css and adding a settings page and menu.
		 *
		 * @since 1.2
		 * @version 1.4.4
		 *
		...
		public static function get_option_parameters() {
			$options = array(
				...
				'tt_default_heading_1' => array(
					...
					'description' => __( "Please select a font for the theme's heading 1 css", 'easy-google-fonts' ),
				...
				'tt_default_heading_2' => array(
					...
					'description' => __( "Please select a font for the theme's heading 2 css", 'easy-google-fonts' ),
				...
				'tt_default_heading_3' => array(
					...
					'description' => __( "Please select a font for the theme's heading 3 css", 'easy-google-fonts' ),
				...
				'tt_default_heading_4' => array(
					...
					'description' => __( "Please select a font for the theme's heading 4 css", 'easy-google-fonts' ),
				...
				'tt_default_heading_5' => array(
					...
					'description' => __( "Please select a font for the theme's heading 5 css", 'easy-google-fonts' ),
				...
				'tt_default_heading_6' => array(
					...
					'description' => __( "Please select a font for the theme's heading 6 css", 'easy-google-fonts' ),
