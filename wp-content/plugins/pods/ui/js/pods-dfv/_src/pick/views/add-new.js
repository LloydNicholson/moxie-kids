...
export const AddNew = PodsFieldView.extend( {
	...
	disable: function () {
		...
		addButton.addClass( DISABLED_CLASS ); // Note: this just css the link (button), click event enforces
	},
	...
	enable: function () {
		const addButton = this.getUI( 'addButton' );
		addButton.removeClass( DISABLED_CLASS ); // Note: this just css the link (button), click event enforces
	},
