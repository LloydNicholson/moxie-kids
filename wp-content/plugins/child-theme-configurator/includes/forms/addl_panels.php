...
<p><?php _e( 'Apply the power of CTC\'s top-rated interface to your site\'s plugin css. All new design makes it much easier to get the results you want.', 'child-theme-configurator' ); ?></p></li>
...
<li><h3><?php _e( 'Find related css', 'child-theme-configurator' ); ?></h3><p><?php _e( 'Use the "All Styles" panel to edit groups of selectors from a single combined list.', 'child-theme-configurator' ); ?></p></li>
<li><h3><?php _e( 'Find css by Nav Menu', 'child-theme-configurator' ); ?></h3><p><?php _e( 'Tweak menus quickly and easily.', 'child-theme-configurator' ); ?></p></li>
