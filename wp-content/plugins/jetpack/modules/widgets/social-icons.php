...
class Jetpack_Widget_Social_Icons extends WP_Widget {
	...
	public function __construct() {
		...
		// Enqueue admin scrips and css, only in the customizer or the old widgets page.
		if ( is_customize_preview() || 'widgets.php' === $pagenow ) {
			add_action( 'admin_enqueue_scripts', array( $this, 'enqueue_admin_scripts' ) );
			add_action( 'admin_print_footer_scripts', array( $this, 'render_admin_js' ) );
		}

		// Enqueue scripts and css for the display of the widget, on the frontend or in the customizer.
	...
	/**
	 * Script & css for admin widget form.
	 */
	...
	public function enqueue_icon_scripts() {
		wp_enqueue_style( 'jetpack-widget-social-icons-css', plugins_url( 'social-icons/social-icons.css', __FILE__ ), array(), '20170506' );
	}
