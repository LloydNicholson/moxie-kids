...
class Jetpack {
	...
	/**
	 * @var array The handles of css that are concatenated into jetpack.css.
	 *
	...
	public $concatenated_style_handles = array(
		...
		'jetpack-widget-social-icons-css',
	);
	...
	private function __construct() {
		 ...
		 *
		 * Super late priority so we catch all the registered css
		 */
		if ( ! is_admin() ) {
...
<div id="message" class="jetpack-message jetpack-err">
	 ...
	 * - Plugins/themes dequeuing css no longer do anything. See
