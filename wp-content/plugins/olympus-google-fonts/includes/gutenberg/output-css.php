...
function ogf_gutenberg_output_css() {
	...
	<style>
		...
		$elements = array(
			'ogf_body' => array(
				'selectors' => '.editor-css-wrapper p, .editor-css-wrapper h3, #editor .editor-css-wrapper .editor-post-title__block .editor-post-title__input',
			),
			'ogf_headings' => array(
				'selectors' => '#editor .editor-css-wrapper .editor-post-title__block .editor-post-title__input, .editor-css-wrapper h1, .editor-css-wrapper h2, .editor-css-wrapper h3, .editor-css-wrapper h4, .editor-css-wrapper h5, .editor-css-wrapper h6',
			),
			'ogf_post_page_content' => array(
				'selectors' => '.editor-css-wrapper p',
			),
			'ogf_post_page_h1' => array(
				'selectors' => '#editor .editor-css-wrapper .editor-post-title__block .editor-post-title__input, .editor-css-wrapper h1',
			),
			'ogf_post_page_h2' => array(
				'selectors' => '.editor-css-wrapper h2',
			),
			'ogf_post_page_h3' => array(
				'selectors' => '.editor-css-wrapper h3',
			),
			'ogf_post_page_h4' => array(
				'selectors' => '.editor-css-wrapper h4',
			),
			'ogf_post_page_h5' => array(
				'selectors' => '.editor-css-wrapper h5',
			),
			'ogf_post_page_h6' => array(
				'selectors' => '.editor-css-wrapper h6',
			),
		);
...
/**
 * Helper function to build the CSS css.
 *
 * @param string $selector    The CSS selector to apply the css to.
