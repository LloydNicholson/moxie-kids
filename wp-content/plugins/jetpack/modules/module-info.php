...
function jetpack_custom_css_more_info() {
	esc_html_e(
		"Add to or replace your theme's CSS including mobile css, LESS, and SaSS.
...
function jetpack_markdown_more_info() {
	esc_html_e(
		'Compose posts and comments with links, lists, and other css using regular characters and
