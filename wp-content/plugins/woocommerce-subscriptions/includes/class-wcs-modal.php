...
class WCS_Modal {
	...
	public static function register_scripts_and_styles() {
		...
		// No need to proceed if the css and scripts have already been enqueued.
		if ( $registered ) {
			return;
		}
	...
	/**
	 * Enqueues the modal scripts and css.
	 *
	 * @since 2.6.0
	 */
	public static function enqueue_scripts_and_styles() {
		...
		wp_enqueue_style( 'wcs-modal-css', plugin_dir_url( WC_Subscriptions::$plugin_file ) . 'assets/css/modal.css', array( 'dashicons' ), WC_Subscriptions::$version );
	}
