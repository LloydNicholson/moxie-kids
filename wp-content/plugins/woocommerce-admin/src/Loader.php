<?php
/**
 * Register the scripts, css, and includes needed for pieces of the WooCommerce Admin experience.
...
class Loader {
	...
	/**
	 * Registers all the neccessary scripts and css to show the admin experience.
	 */
