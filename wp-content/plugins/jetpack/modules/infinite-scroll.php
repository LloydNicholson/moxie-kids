...
class Jetpack_Infinite_Scroll_Extras {
	...
	public function action_wp_enqueue_scripts() {
		// Do not load scripts and css on singular pages and static pages
		$load_scripts_and_styles = ! ( is_singular() || is_page() );
		if (
			/**
			 * Allow plugins to enqueue all Infinite Scroll scripts and css on singular pages as well.
			 *
			 *  @module infinite-scroll
			 *
			 * @since 3.1.0
			 *
			 * @param bool $load_scripts_and_styles Should scripts and css be loaded on singular pahes and static pages. Default to false.
			 */
