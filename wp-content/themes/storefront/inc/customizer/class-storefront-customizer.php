...
if ( ! class_exists( 'Storefront_Customizer' ) ) :
	...
	class Storefront_Customizer {
		...
		public function block_editor_customizer_css() {
			...
			if ( is_admin() ) {
				$styles .= '
				.editor-css-wrapper table:not( .has-background ) th {
					background-color: ' . storefront_adjust_color_brightness( $storefront_theme_mods['background_color'], -7 ) . ';
				}

				.editor-css-wrapper table:not( .has-background ) tbody td {
					background-color: ' . storefront_adjust_color_brightness( $storefront_theme_mods['background_color'], -2 ) . ';
				}

				.editor-css-wrapper table:not( .has-background ) tbody tr:nth-child(2n) td,
				.editor-css-wrapper fieldset,
				.editor-css-wrapper fieldset legend {
					background-color: ' . storefront_adjust_color_brightness( $storefront_theme_mods['background_color'], -4 ) . ';
				}

				.editor-post-title__block .editor-post-title__input,
				.editor-css-wrapper h1,
				.editor-css-wrapper h2,
				.editor-css-wrapper h3,
				.editor-css-wrapper h4,
				.editor-css-wrapper h5,
				.editor-css-wrapper h6 {
					color: ' . $storefront_theme_mods['heading_color'] . ';
				}

				.editor-css-wrapper .editor-block-list__block {
					color: ' . $storefront_theme_mods['text_color'] . ';
				}

				.editor-css-wrapper a,
				.wp-block-freeform.block-library-rich-text__tinymce a {
					color: ' . $storefront_theme_mods['accent_color'] . ';
				}

				.editor-css-wrapper a:focus,
		...
		/**
		 * Assign Storefront css to individual theme mods.
		 *
		 * @deprecated 2.3.1
		 * @return void
		 */
