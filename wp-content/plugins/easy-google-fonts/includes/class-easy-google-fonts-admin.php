...
if ( ! class_exists( 'Easy_Google_Fonts_Admin' ) ) :
	class Easy_Google_Fonts_Admin {
		 ...
		 * 
		 * Initialize the plugin by loading admin scripts & css and adding a
		...
		public function enqueue_admin_styles() {
			...
			if ( $this->plugin_screen_hook_suffix == $screen->id ) {
				wp_deregister_style( $this->plugin_slug .'-admin-css' );
				wp_register_style( 
		...
		public function add_help_tabs() {
			...
			if ( $this->plugin_screen_hook_suffix == $screen->id ) {
				...
				$edit_content .= '<li>' . __( 'Add CSS Selectors: Add any CSS selectors/css that you want this custom font control to manage.', 'easy-google-fonts' ) . '</li>';
				$edit_content .= '<li>' . __( "Force Styles Override (Optional): If your theme is forcing any css in it's stylesheet for any css managed by this control then check this option to force a stylesheet override.", 'easy-google-fonts' ) . '</li></ul>';
				...
				$manage_content .= '<li>' . __( "Force Styles Override (Optional): If your theme is forcing any css in it's stylesheet for any css managed by this control then check this option to force a stylesheet override.", 'easy-google-fonts' ) . '</li></ul>';
